...
proc create_hier_cell_filter { parentCell nameHier } {
  ...
  set_property -dict [ list \
   ...
   CONFIG.Sample_Frequency {0.048000} \
 ] $fir
  ...
  connect_bd_intf_net -intf_net fir_config_M_AXI_MM2S [get_bd_intf_pins M_AXI_MM2S2] [get_bd_intf_pins fir_config/M_AXI_MM2S]
  connect_bd_intf_net -intf_net fir_data_M_AXIS_MM2S [get_bd_intf_pins fir/S_AXIS_DATA] [get_bd_intf_pins fir_data/M_AXIS_MM2S]
  ...
  connect_bd_intf_net -intf_net fir_reload_M_AXIS_MM2S [get_bd_intf_pins fir/S_AXIS_RELOAD] [get_bd_intf_pins fir_reload/M_AXIS_MM2S]
  connect_bd_intf_net -intf_net fir_reload_M_AXI_MM2S [get_bd_intf_pins M_AXI_MM2S1] [get_bd_intf_pins fir_reload/M_AXI_MM2S]
  connect_bd_intf_net -intf_net ps8_0_axi_periph_M00_AXI [get_bd_intf_pins S_AXI_LITE2] [get_bd_intf_pins fir_config/S_AXI_LITE]
  connect_bd_intf_net -intf_net ps8_0_axi_periph_M01_AXI [get_bd_intf_pins S_AXI_LITE] [get_bd_intf_pins fir_data/S_AXI_LITE]
  connect_bd_intf_net -intf_net ps8_0_axi_periph_M02_AXI [get_bd_intf_pins S_AXI_LITE1] [get_bd_intf_pins fir_reload/S_AXI_LITE]

  # Create port connections
  connect_bd_net -net rst_ps8_0_96M_peripheral_aresetn [get_bd_pins axi_resetn] [get_bd_pins fir_config/axi_resetn] [get_bd_pins fir_data/axi_resetn] [get_bd_pins fir_reload/axi_resetn]
...
proc create_hier_cell_fft { parentCell nameHier } {
  ...
  # Create interface connections
  connect_bd_intf_net -intf_net axi_dma_0_M_AXIS_MM2S [get_bd_intf_pins fft/S_AXIS_DATA] [get_bd_intf_pins fft_data/M_AXIS_MM2S]
  connect_bd_intf_net -intf_net fft_config_M_AXIS_MM2S [get_bd_intf_pins fft/S_AXIS_CONFIG] [get_bd_intf_pins fft_config/M_AXIS_MM2S]
  ...
  connect_bd_intf_net -intf_net xfft_0_M_AXIS_DATA [get_bd_intf_pins fft/M_AXIS_DATA] [get_bd_intf_pins fft_data/S_AXIS_S2MM]

  # Create port connections
  connect_bd_net -net rst_ps8_0_96M_peripheral_aresetn [get_bd_pins axi_resetn] [get_bd_pins fft_config/axi_resetn] [get_bd_pins fft_data/axi_resetn]
  connect_bd_net -net zynq_ultra_ps_e_0_pl_clk0 [get_bd_pins aclk] [get_bd_pins fft/aclk] [get_bd_pins fft_config/m_axi_mm2s_aclk] [get_bd_pins fft_config/s_axi_lite_aclk] [get_bd_pins fft_data/m_axi_mm2s_aclk] [get_bd_pins fft_data/m_axi_s2mm_aclk] [get_bd_pins fft_data/s_axi_lite_aclk]
...
proc create_root_design { parentCell } {
  ...
  connect_bd_intf_net -intf_net fir_config_M_AXI_MM2S [get_bd_intf_pins axi_smc/S00_AXI] [get_bd_intf_pins filter/M_AXI_MM2S2]
  connect_bd_intf_net -intf_net fir_data_M_AXI_MM2S [get_bd_intf_pins axi_smc/S01_AXI] [get_bd_intf_pins filter/M_AXI_MM2S]
  connect_bd_intf_net -intf_net fir_data_M_AXI_S2MM [get_bd_intf_pins axi_smc/S02_AXI] [get_bd_intf_pins filter/M_AXI_S2MM]
  connect_bd_intf_net -intf_net fir_reload_M_AXI_MM2S [get_bd_intf_pins axi_smc/S03_AXI] [get_bd_intf_pins filter/M_AXI_MM2S1]
  connect_bd_intf_net -intf_net ps8_0_axi_periph_M00_AXI [get_bd_intf_pins filter/S_AXI_LITE2] [get_bd_intf_pins ps8_0_axi_periph/M00_AXI]
  connect_bd_intf_net -intf_net ps8_0_axi_periph_M01_AXI [get_bd_intf_pins filter/S_AXI_LITE] [get_bd_intf_pins ps8_0_axi_periph/M01_AXI]
  connect_bd_intf_net -intf_net ps8_0_axi_periph_M02_AXI [get_bd_intf_pins filter/S_AXI_LITE1] [get_bd_intf_pins ps8_0_axi_periph/M02_AXI]
  ...
  # Create port connections
  connect_bd_net -net rst_ps8_0_96M_peripheral_aresetn [get_bd_pins axi_smc/aresetn] [get_bd_pins fft/axi_resetn] [get_bd_pins filter/axi_resetn] [get_bd_pins ps8_0_axi_periph/ARESETN] [get_bd_pins ps8_0_axi_periph/M00_ARESETN] [get_bd_pins ps8_0_axi_periph/M01_ARESETN] [get_bd_pins ps8_0_axi_periph/M02_ARESETN] [get_bd_pins ps8_0_axi_periph/M03_ARESETN] [get_bd_pins ps8_0_axi_periph/M04_ARESETN] [get_bd_pins ps8_0_axi_periph/S00_ARESETN] [get_bd_pins rst_ps8_0_96M/peripheral_aresetn]
  connect_bd_net -net zynq_ultra_ps_e_0_pl_clk0 [get_bd_pins axi_smc/aclk] [get_bd_pins fft/aclk] [get_bd_pins filter/m_axi_mm2s_aclk] [get_bd_pins ps8_0_axi_periph/ACLK] [get_bd_pins ps8_0_axi_periph/M00_ACLK] [get_bd_pins ps8_0_axi_periph/M01_ACLK] [get_bd_pins ps8_0_axi_periph/M02_ACLK] [get_bd_pins ps8_0_axi_periph/M03_ACLK] [get_bd_pins ps8_0_axi_periph/M04_ACLK] [get_bd_pins ps8_0_axi_periph/S00_ACLK] [get_bd_pins rst_ps8_0_96M/slowest_sync_clk] [get_bd_pins zynq_ultra_ps_e_0/maxihpm0_fpd_aclk] [get_bd_pins zynq_ultra_ps_e_0/pl_clk0] [get_bd_pins zynq_ultra_ps_e_0/saxihp0_fpd_aclk]
  ...
  assign_bd_address -offset 0xA0004000 -range 0x00001000 -target_address_space [get_bd_addr_spaces zynq_ultra_ps_e_0/Data] [get_bd_addr_segs fft/fft_config/S_AXI_LITE/Reg] -force
  assign_bd_address -offset 0xA0003000 -range 0x00001000 -target_address_space [get_bd_addr_spaces zynq_ultra_ps_e_0/Data] [get_bd_addr_segs fft/fft_data/S_AXI_LITE/Reg] -force
  assign_bd_address -offset 0xA0000000 -range 0x00001000 -target_address_space [get_bd_addr_spaces zynq_ultra_ps_e_0/Data] [get_bd_addr_segs filter/fir_config/S_AXI_LITE/Reg] -force
  assign_bd_address -offset 0xA0001000 -range 0x00001000 -target_address_space [get_bd_addr_spaces zynq_ultra_ps_e_0/Data] [get_bd_addr_segs filter/fir_data/S_AXI_LITE/Reg] -force
  assign_bd_address -offset 0xA0002000 -range 0x00001000 -target_address_space [get_bd_addr_spaces zynq_ultra_ps_e_0/Data] [get_bd_addr_segs filter/fir_reload/S_AXI_LITE/Reg] -force
  assign_bd_address -offset 0x00000000 -range 0x80000000 -target_address_space [get_bd_addr_spaces fft/fft_config/Data_MM2S] [get_bd_addr_segs zynq_ultra_ps_e_0/SAXIGP2/HP0_DDR_LOW] -force
  assign_bd_address -offset 0x00000000 -range 0x80000000 -target_address_space [get_bd_addr_spaces fft/fft_data/Data_MM2S] [get_bd_addr_segs zynq_ultra_ps_e_0/SAXIGP2/HP0_DDR_LOW] -force
  assign_bd_address -offset 0x00000000 -range 0x80000000 -target_address_space [get_bd_addr_spaces fft/fft_data/Data_S2MM] [get_bd_addr_segs zynq_ultra_ps_e_0/SAXIGP2/HP0_DDR_LOW] -force
  assign_bd_address -offset 0x00000000 -range 0x80000000 -target_address_space [get_bd_addr_spaces filter/fir_config/Data_MM2S] [get_bd_addr_segs zynq_ultra_ps_e_0/SAXIGP2/HP0_DDR_LOW] -force
  assign_bd_address -offset 0xFF000000 -range 0x01000000 -target_address_space [get_bd_addr_spaces filter/fir_config/Data_MM2S] [get_bd_addr_segs zynq_ultra_ps_e_0/SAXIGP2/HP0_LPS_OCM] -force
  assign_bd_address -offset 0x00000000 -range 0x80000000 -target_address_space [get_bd_addr_spaces filter/fir_data/Data_MM2S] [get_bd_addr_segs zynq_ultra_ps_e_0/SAXIGP2/HP0_DDR_LOW] -force
  assign_bd_address -offset 0x00000000 -range 0x80000000 -target_address_space [get_bd_addr_spaces filter/fir_data/Data_S2MM] [get_bd_addr_segs zynq_ultra_ps_e_0/SAXIGP2/HP0_DDR_LOW] -force
  assign_bd_address -offset 0xFF000000 -range 0x01000000 -target_address_space [get_bd_addr_spaces filter/fir_data/Data_MM2S] [get_bd_addr_segs zynq_ultra_ps_e_0/SAXIGP2/HP0_LPS_OCM] -force
  assign_bd_address -offset 0xFF000000 -range 0x01000000 -target_address_space [get_bd_addr_spaces filter/fir_data/Data_S2MM] [get_bd_addr_segs zynq_ultra_ps_e_0/SAXIGP2/HP0_LPS_OCM] -force
  assign_bd_address -offset 0x00000000 -range 0x80000000 -target_address_space [get_bd_addr_spaces filter/fir_reload/Data_MM2S] [get_bd_addr_segs zynq_ultra_ps_e_0/SAXIGP2/HP0_DDR_LOW] -force
  assign_bd_address -offset 0xFF000000 -range 0x01000000 -target_address_space [get_bd_addr_spaces filter/fir_reload/Data_MM2S] [get_bd_addr_segs zynq_ultra_ps_e_0/SAXIGP2/HP0_LPS_OCM] -force
